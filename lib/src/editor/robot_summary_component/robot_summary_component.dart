...
import '../robot_component/robot_component.dart';

@Component(
    selector: 'robot-summary-component',
    templateUrl: 'robot_summary_component.html',
    styleUrls: const [
      'robot_summary_component.css'
    ],
    directives: const [
      materialDirectives,
      CORE_DIRECTIVES,
...
class RobotSummaryComponent implements OnInit {
...
//  TODO get values from robot
  ...
  RobotSummaryComponent(this.botz) {
    rankLabelFunction =
